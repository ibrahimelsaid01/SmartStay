...
export interface HostPropertyStatusSummary {
...
export class HostPropertiesService {
  private readonly hostPropertiesUrl = `${environment.baseApi}/api/host/properties`;
    ...
    return this.http
      ...
      .pipe(
        map(responseText => {
          ...
          } as HostPropertiesResponse;
        })
      );
  }

  getMyPropertiesSummary(): Observable<HostPropertyStatusSummary> {
    return this.http
      .get(`${this.hostPropertiesUrl}/summary`, {
        responseType: 'text',
      })
      .pipe(
        map(responseText => {
  ...
  createDraft(
    ...
    return this.http
      .post(`${this.hostPropertiesUrl}/draft`, request, {
        responseType: 'text',
      })
      .pipe(
        map(responseText => JSON.parse(responseText) as PropertyDraftResponse)
      );
  }

  getPropertyById(propertyId: string): Observable<PropertyDraftResponse> {
    return this.http
      .get(`${this.hostPropertiesUrl}/${propertyId}`, {
        responseType: 'text',
      })
      .pipe(
        map(responseText => JSON.parse(responseText) as PropertyDraftResponse)
  ...
  getEditor(propertyId: string): Observable<PropertyEditorResponse> {
    return this.http
      .get(`${this.hostPropertiesUrl}/${propertyId}/editor`, {
        responseType: 'text',
      })
      .pipe(
        map(responseText => JSON.parse(responseText) as PropertyEditorResponse)
      );
  }
  ...
  updateBasicInformation(
    ...
    return this.http
      .put(`${this.hostPropertiesUrl}/${propertyId}/basic-information`, request, {
        responseType: 'text',
      })
      .pipe(
        map(responseText => JSON.parse(responseText) as PropertyDraftResponse)
  ...
  updateLocation(
    ...
    return this.http
      .put(`${this.hostPropertiesUrl}/${propertyId}/location`, request, {
        responseType: 'text',
      })
      .pipe(
        map(responseText => JSON.parse(responseText) as PropertyLocationResponse)
      );
  }
  ...
  updateCapacity(
    ...
    return this.http
      .put(`${this.hostPropertiesUrl}/${propertyId}/capacity`, request, {
        responseType: 'text',
      })
      .pipe(
        map(responseText => JSON.parse(responseText) as PropertyCapacityResponse)
      );
  }
  ...
  updatePricingAndPolicies(
    ...
    return this.http
      .put(`${this.hostPropertiesUrl}/${propertyId}/pricing-and-policies`, request, {
        responseType: 'text',
      })
      .pipe(
        map(
          responseText =>
            JSON.parse(responseText) as PropertyPricingAndPoliciesResponse
        )
      );
  }
  ...
  updateHouseRules(
    ...
    return this.http
      .put(`${this.hostPropertiesUrl}/${propertyId}/house-rules`, request, {
        responseType: 'text',
      })
      .pipe(
        map(responseText => JSON.parse(responseText) as PropertyHouseRulesResponse)
      );
  }
  ...
  getPropertyAmenities(propertyId: string): Observable<PropertyAmenitiesResponse> {
    return this.http
      .get(`${this.hostPropertiesUrl}/${propertyId}/amenities`, {
        responseType: 'text',
      })
      .pipe(
        map(responseText => JSON.parse(responseText) as PropertyAmenitiesResponse)
      );
  }
  ...
  updateAmenities(
    ...
    return this.http
      .put(`${this.hostPropertiesUrl}/${propertyId}/amenities`, request, {
        responseType: 'text',
      })
      .pipe(
        map(responseText => JSON.parse(responseText) as PropertyAmenitiesResponse)
  ...
  getImages(propertyId: string): Observable<PropertyImagesResponse> {
    return this.http
      .get(`${this.hostPropertiesUrl}/${propertyId}/images`, {
        responseType: 'text',
      })
      .pipe(
        map(responseText => JSON.parse(responseText) as PropertyImagesResponse)
      );
  }
  ...
  uploadImages(
    ...
    return this.http
      .post(`${this.hostPropertiesUrl}/${propertyId}/images`, formData, {
        responseType: 'text',
      })
      .pipe(
        map(responseText => JSON.parse(responseText) as PropertyImagesResponse)
  ...
  deleteImage(
    ...
    return this.http
      .delete(`${this.hostPropertiesUrl}/${propertyId}/images/${imageId}`, {
        responseType: 'text',
      })
      .pipe(
        map(responseText => JSON.parse(responseText) as PropertyImagesResponse)
  ...
  setCoverImage(
    ...
    return this.http
      .put(`${this.hostPropertiesUrl}/${propertyId}/images/${imageId}/cover`, {}, {
        responseType: 'text',
      })
      .pipe(
        map(responseText => JSON.parse(responseText) as PropertyImagesResponse)
  ...
  updateImageOrder(
    ...
    return this.http
      .put(`${this.hostPropertiesUrl}/${propertyId}/images/order`, request, {
        responseType: 'text',
      })
      .pipe(
        map(responseText => JSON.parse(responseText) as PropertyImagesResponse)
  ...
  getVerificationDocument(
    ...
    return this.http
      .get(`${this.hostPropertiesUrl}/${propertyId}/verification-document`, {
        responseType: 'text',
      })
      .pipe(
        map(
          responseText =>
            JSON.parse(responseText) as PropertyVerificationDocumentResponse
        )
      );
  }
  ...
  uploadVerificationDocument(
    ...
    return this.http
      .post(
        `${this.hostPropertiesUrl}/${propertyId}/verification-document`,
        formData,
        {
          responseType: 'text',
        }
  ...
  getVerificationDocumentPageContent(
    ...
    return this.http.get(
      `${this.hostPropertiesUrl}/${propertyId}/verification-document/pages/${pageId}/content`,
      {
        responseType: 'blob',
      }
    );
  ...
  submitProperty(propertyId: string): Observable<PropertySubmissionResponse> {
    return this.http
      .post(`${this.hostPropertiesUrl}/${propertyId}/submit`, {}, {
        responseType: 'text',
      })
      .pipe(
        map(responseText => JSON.parse(responseText) as PropertySubmissionResponse)
      );
  }
  ...
  unpublishProperty(
    ...
    return this.http
      .post(`${this.hostPropertiesUrl}/${propertyId}/unpublish`, {}, {
        responseType: 'text',
      })
      .pipe(
        map(
          responseText =>
            JSON.parse(responseText) as HostPropertyUnpublishResponse
        )
      );
  }
}